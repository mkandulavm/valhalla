...
const std::unordered_map<unsigned, valhalla::valhalla_exception_t> error_codes{
    ...
    {450,
     {450,
      "[450] No path found: the available roads are restricted to trucks with local access only, and there isn’t any nearby road you’re allowed to use.",
      400,
      HTTP_400,
      OSRM_NO_ROUTE,
      "no_path_truck_permit_hgv_destination_avoided"}},
